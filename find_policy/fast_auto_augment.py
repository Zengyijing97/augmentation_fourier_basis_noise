...
DEFALUT_CANDIDATES = [
    ...
    FourierBasisNoise_8,
    FourierBasisNoise_9,
    FourierBasisNoise_10,
    FourierBasisNoise_11,
    FourierBasisNoise_12,
    FourierBasisNoise_13,
    FourierBasisNoise_14,
    FourierBasisNoise_15,
    FourierBasisNoise_16,
    FourierBasisNoise_17,
    FourierBasisNoise_18,
    FourierBasisNoise_19,
    FourierBasisNoise_20,
    FourierBasisNoise_21,
    FourierBasisNoise_22,
]
...
def search_subpolicies_hyperopt(args, transform_candidates, child_model, dataset, Da_indx, B, device):
    ...
    space = [(hp.choice('transform1', transform_candidates), hp.uniform('prob1', 0, 1.0), hp.uniform('mag1', 1.0, 5.0)),
             (hp.choice('transform2', transform_candidates), hp.uniform('prob2', 0, 1.0), hp.uniform('mag2', 1.0, 5.0))]
